...
def calc_stat(is_weapon: bool, base: int, is_attack: bool) -> list:
    ...
    max_result: int = int(1 + (base // ((4.2 if is_attack else 2.1) * (2.5 if is_weapon and is_attack else 1.05))))
...
def get_average(is_weapon: bool, base: int, is_attack: bool, level_until: int = 7, simulations = 100) -> int:
    _sum: list = []
